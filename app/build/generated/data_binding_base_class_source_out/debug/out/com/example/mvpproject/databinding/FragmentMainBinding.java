...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appTv,
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.app_tv;
      TextView appTv = rootView.findViewById(id);
      if (appTv == null) {
        break missingId;
      }
      ...
      return new FragmentMainBinding((ConstraintLayout) rootView, appTv, imageView);
    }
